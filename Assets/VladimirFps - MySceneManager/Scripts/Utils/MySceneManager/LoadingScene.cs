...
namespace VladimirFps.Utils
{
    ...
    public class LoadingScene : MonoBehaviour
    {
        ...
        [SerializeField] private int _indexSceneForFirstLaunching = 1;
        ...
        private void Awake()
        {
            if (MySceneManager.IsFirstLaunched)
            {
                MySceneManager.LoadScene(_indexSceneForFirstLaunching);
            }
        }
